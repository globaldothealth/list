...
def test_csv_header():
    ...
    assert (
        header_line
        == "_id,confirmationDate,caseReference.sourceId,caseReference.status,location.latitude,location.longitude,location.admin1,location.admin2,location.admin3,location.country\r\n"
    )
