...
parser.add_argument("--mongodb_connection_string", default=uri)
...
def export_chunk(skip, limit, num_cases, num_chunk, field_names):
    ...
    chunk_fn = f"{args.collection}_{z_num_chunk}-of-{z_num_chunks}.{args.format}"
    subprocess.run(
        [
            "mongoexport",
...
if __name__ == "__main__":
    ...
    for i in range(num_cases // limit):
        ...
        response = s3.upload_file(chunk, "covid-19-data-export", s3_fn)
