...
_PARSED_CASE = (
    {'caseReference': {'sourceId': 'abc123', 'sourceUrl': 'https://ti.saude.rs.gov.br/covid19/download'},
     ...
     'events': [{'name': 'confirmed',
        ...
        'preexistingConditions': {'hasPreexistingConditions': True,
                                  'values': ['other']},
        'notes': 'Patient with immunodeficiency, Neighbourhood: Centro Historico, Indigenous ethnicity: Branca'})
...
class RGDSTest(unittest.TestCase):
    def test_parse(self):
        ...
        result = next(riograndedosul.parse_cases(
