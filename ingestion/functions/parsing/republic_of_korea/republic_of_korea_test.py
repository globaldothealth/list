...
class RepublicOfKoreaTest(unittest.TestCase):
  ...
  'demographics': {'ageRange': {'start': 35.0, 'end': 36.0},
   'gender': 'Female'},
 ...
 {'caseReference': {'sourceId': 'placeholder_ID',
  ...
  'demographics': {'ageRange': {'start': 55.0, 'end': 56.0}, 'gender': 'Male'},
  'travelHistory': {'traveledPrior30Days': True},
 ...
 {'caseReference': {'sourceId': 'placeholder_ID',
  ...
  'demographics': {'ageRange': {'start': 53.0, 'end': 54.0}, 'gender': 'Male'},
 ...
 {'caseReference': {'sourceId': 'placeholder_ID',
  ...
  'demographics': {'ageRange': {'start': 32.0, 'end': 33.0}, 'gender': 'Male'},
 ...
 {'caseReference': {'sourceId': 'placeholder_ID',
  ...
  'demographics': {'ageRange': {'start': 28.0, 'end': 29.0}, 'gender': 'Male'},
 ...
 {'caseReference': {'sourceId': 'placeholder_ID',
  ...
  'events': [{'name': 'confirmed',
   ...
   {'name': 'outcome',
    'value': 'Recovered',
    'dateRange': {'start': '02/12/2020Z', 'end': '02/12/2020Z'}}],
  'demographics': {'ageRange': {'start': 62.0, 'end': 63.0},
   'gender': 'Female'},
 ...
 {'caseReference': {'sourceId': 'placeholder_ID',
  ...
  'demographics': {'ageRange': {'start': 27.0, 'end': 28.0},
   'gender': 'Female'},
 ...
 {'caseReference': {'sourceId': 'placeholder_ID',
  ...
  'events': [{'name': 'confirmed',
   ...
   {'name': 'outcome',
    'value': 'Recovered',
    'dateRange': {'start': '02/19/2020Z', 'end': '02/19/2020Z'}}],
  'demographics': {'ageRange': {'start': 53.0, 'end': 54.0},
   'gender': 'Female'},
