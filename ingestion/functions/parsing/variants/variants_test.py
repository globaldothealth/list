...
class VariantsTest(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        result = variants.parse_cases(sample_data_file, _SOURCE_ID)
        self.assertCountEqual(list(result),
                              [{'caseReference': {'sourceId': 'placeholder_ID',
                                ...
                                'events': [{'name': 'confirmed',
                                  ...
                                  'travelHistory': {'traveledPrior30Days': 'No'},
                               ...
                               {'caseReference': {'sourceId': 'placeholder_ID',
                                  ...
                                  'travelHistory': {'traveledPrior30Days': 'Yes',
                               ...
                               {'caseReference': {'sourceId': 'placeholder_ID',
                                  ...
                                  'travelHistory': {'traveledPrior30Days': 'Yes',
                                                    'travel': {'methods': 'Flight', 'location': {'query': 'South Africa'}}}},
                               {'caseReference': {'sourceId': 'placeholder_ID',
