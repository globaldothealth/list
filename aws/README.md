...
[Github](https://ghcr.io/globaldothealth/list/blob/master/.github/workflows/data-service-package.yml) [actions](https://github.com/globaldothealth/list/blob/master/.github/workflows/curator-package.yml) will automatically build the image: `ghcr.io/globaldothealth/list/curatorservice:curator-0.1.2`.
