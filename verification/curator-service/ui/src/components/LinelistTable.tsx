                ...
                {this.props.user ? (
                    <>
                        ...
                        {!this.props.location.state?.bulkMessage &&
                            ...
                            (this.props.location.state.newCaseIds.length ===
                            1 ? (
                                <MuiAlert
                                    classes={{
                                        root: classes.alert,
                        ...
                        {!this.props.location.state?.bulkMessage &&
                            (this.props.location.state?.editedCaseIds?.length ??
                                0) > 0 && (
                                <MuiAlert
                                    variant="standard"
                                    classes={{ root: classes.alert }}
                        ...
                        >
                            ...
                            <DialogActions>
                                {this.state.isDeleting ? (
                                    <CircularProgress
                                        classes={{
                                            root: classes.dialogLoadingSpinner,
                                        }}
                                    />
                                ) : (
                                    <>
