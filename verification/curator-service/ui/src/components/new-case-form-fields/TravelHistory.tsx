...
const TooltipText = () => (
  <StyledTooltip>
    <ul>
      ...
      <li><strong>Primary reason for travel:</strong> Enter the primary reason for travel if provided:
        <ul>
          ...
          <li><strong>Family:</strong> The case was traveling to met family</li>
