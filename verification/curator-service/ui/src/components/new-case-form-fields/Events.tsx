      ...
      <ul>
        ...
        <li><strong>First clinical consultation date:</strong> Enter the date of the first clinical consultation of any type reported by the patient.
          <ul>
            ...
            <li>If no clinical consulation was sought, or the source does not provide any details leave blank.</li>
          </ul>
        </li>
        <li><strong>Self isolation date:</strong> Enter the date reported if the case went into self isolation.
          <ul>
